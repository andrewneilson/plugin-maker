...
These patterns are battle-tested in production plugins.
...
### Pattern 7: Configuration-Driven Hooks
...
**Use for:** User-configurable hook behavior and per-project settings.
...
- ✅ Use proven patterns from this guide
